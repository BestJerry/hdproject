...
public class AdminDAO extends BaseDAO {
	...
	public static final String _APSD = "APsd";
	public static final String _AFLAG = "AFlag";
	...
	public Admin findById(java.lang.String id) {
		...
		try {
			Admin instance = (Admin) getSession().get("bean.Admin", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Admin instance) {
		...
		try {
			List results = getSession().createCriteria("bean.Admin").add(Example.create(instance)).list();
	...
	public List findByAPsd(Object APsd) {
		return findByProperty(_APSD, APsd);
	}

	public List findByAFlag(Object AFlag) {
		return findByProperty(_AFLAG, AFlag);
	}
