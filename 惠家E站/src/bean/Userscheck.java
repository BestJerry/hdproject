...
public class Userscheck implements java.io.Serializable {
	...
	/** minimal constructor */
	public Userscheck(String ucNumber, Date ucCommitdate, Boolean ucFlag) {
	...
	/** full constructor */
	public Userscheck(String ucNumber, Date ucCommitdate, Boolean ucFlag, Date ucEnddate, Set userses) {
		this.ucNumber = ucNumber;
		this.ucCommitdate = ucCommitdate;
		this.ucFlag = ucFlag;
